...
def hybrid(x0, lmr_z, par_z, gb_mol, je, cair, oair, rh_can, p, iv, c):
    ...
    f0, gs_mol, _ = ci_func(x0, lmr_z, par_z, gb_mol, je, cair, oair, rh_can, p, iv, c)
    ...
    f1, gs_mol, _ = ci_func(x1, lmr_z, par_z, gb_mol, je, cair, oair, rh_can, p, iv, c)
    ...
    while True:
        ...
        f1, gs_mol, _ = ci_func(
            x1, lmr_z, par_z, gb_mol, je, cair, oair, rh_can, p, iv, c
        )
...
def main(
    ...
    _, _, an = ci_func(ci_val, lmr_z, par_z, gb_mol, je, cair, oair, rh_can, p, iv, c)
